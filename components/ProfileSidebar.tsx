  ...
  return (
    <aside className="w-full lg:w-55">
      <div className="mb-4 flex items-center gap-2.5 rounded-xl border border-[#1e1e2e] bg-[#111118] p-3">
        <Avatar size="sm" />
        <div>
          <p className="text-[13px] font-semibold text-[#e2e8f0] capitalize">{user.name.split(" ")[0]}</p>
          <p className="text-[11px] text-[#64748b]">devlinks.app/{user.username}</p>
        </div>
      </div>
      <nav className="flex flex-col gap-1">
        ...
        <button className="flex w-full items-center gap-2.5 rounded-lg px-3 py-2.5 text-[13px] font-medium text-red-400 transition-all hover:bg-red-400/10">
